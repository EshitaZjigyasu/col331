...
@@ -165,6 +169,9 @@ consoleintr(int (*getc)(void))
       break;
     }
   }
+  if(doprocdump) {
...
diff --git a/diff_study/.gdbinit.tmpl.md b/diff_study/.gdbinit.tmpl.md
deleted file mode 100644
index 8e19937..0000000
--- a/diff_study/.gdbinit.tmpl.md
+++ /dev/null
@@ -1,10 +0,0 @@
...
diff --git a/diff_study/defs.h.md b/diff_study/defs.h.md
deleted file mode 100644
index 9653d4b..0000000
--- a/diff_study/defs.h.md
+++ /dev/null
@@ -1,15 +0,0 @@
-# defs.h Changes
-
...
\ No newline at end of file
diff --git a/diff_study/diff-14-15.md b/diff_study/diff-14-15.md
deleted file mode 100644
index 92f14a6..0000000
--- a/diff_study/diff-14-15.md
+++ /dev/null
@@ -1,1982 +0,0 @@
...
diff --git a/diff_study/memlayout.h.md b/diff_study/memlayout.h.md
deleted file mode 100644
index 7d4e111..0000000
--- a/diff_study/memlayout.h.md
+++ /dev/null
@@ -1,11 +0,0 @@
...
-
-## Minor Code Cleanups
-- `file.c`: Simplified comments on `ip->nlink` and `iput` operations.
-- `fs.c`: Removed explanatory comment from device check in `readi`.
-
-## Documentation and Deleted Content
-- The entire `diff_study/` directory was removed, including several markdown files documenting earlier diffs (12–14). These files were outdated and not relevant to the current state.
-
-## Other Notes
-- New documentation file `p14-segments.md` provides an overview of segmentation and is part of the project’s educational materials.
-
-These entries capture small edits and the cleanup of old diff documentation.
\ No newline at end of file
diff --git a/diff_study/mmu.h.md b/diff_study/mmu.h.md
deleted file mode 100644
index cbc9f67..0000000
--- a/diff_study/mmu.h.md
+++ /dev/null
@@ -1,15 +0,0 @@
-# mmu.h Changes
...
\ No newline at end of file
diff --git a/diff_study/proc.c.md b/diff_study/proc.c.md
deleted file mode 100644
index c8b4fbc..0000000
--- a/diff_study/proc.c.md
+++ /dev/null
@@ -1,10 +0,0 @@
-# proc.c Changes
-
...
\ No newline at end of file
diff --git a/diff_study/swtch.S.md b/diff_study/swtch.S.md
deleted file mode 100644
index 3568b59..0000000
--- a/diff_study/swtch.S.md
+++ /dev/null
@@ -1,25 +0,0 @@
-# swtch.S (New File)
-
...
\ No newline at end of file
diff --git a/diff_study/vm.c.md b/diff_study/vm.c.md
deleted file mode 100644
index 4d20daf..0000000
--- a/diff_study/vm.c.md
+++ /dev/null
@@ -1,19 +0,0 @@
-# vm.c Changes
-
...
\ No newline at end of file
diff --git a/log.c b/log.c
index d4b8246..efa0692 100644
--- a/log.c
+++ b/log.c
@@ -179,11 +179,11 @@ log_write(struct buf *b)
...
+data segments define *required privilege level (RPL)* for the segment. This
 ...
 level of RPL or higher (i.e, with CPL <= RPL). Similarly, *descriptor privilege
 level (DPL)* is also set in segment descriptor set in GDT. Note how `pinit`
@@ -124,4 +124,4 @@ segment, code segment, and `eip`. Since, `eip` was set to zero in our fake
 > Note that we have not yet setup capability to safely get the control back from
 the process. If you press a key in the console after the process has started
 running, we will see that the OS crashes. We will add this capability in the 
-next part.
+next part.
\ No newline at end of file
diff --git a/p16-tss.md b/p16-tss.md
new file mode 100644
index 0000000..15a9e1a
--- /dev/null
+++ b/p16-tss.md
@@ -0,0 +1,59 @@
...
+#include "proc.h"
 ...
 // Record the current call stack in pcs[] by following the %ebp chain.
 void
@@ -19,4 +23,32 @@ getcallerpcs(void *v, uint pcs[])
   }
   for(; i < 10; i++)
     pcs[i] = 0;
-}
...
\ No newline at end of file
diff --git a/x86.h b/x86.h
index 2a0992e..cc0e9d5 100644
--- a/x86.h
+++ b/x86.h
@@ -85,6 +85,12 @@ lidt(struct gatedesc *p, int size)
   asm volatile("lidt (%0)" : : "r" (pd));
 }
